    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 print-page">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="flex items-center space-x-2 no-print">
                ...
                <a href="{{ route('librarian.reports.print', 'book-usage') }}?date_from={{ $data['period']['from'] }}&date_to={{ $data['period']['to'] }}" target="_blank" class="px-3 py-2 rounded-lg bg-gray-700 hover:bg-gray-800 text-white">
        ...
        <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="p-4 overflow-x-auto">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="text-gray-900">
                            ...
                            @empty
                            <tr><td colspan="5" class="py-4 text-gray-500">No data.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
            ...
            <div class="bg-white border rounded-lg">
                <div class="p-4 border-b">
                    <h2 class="text-lg font-semibold text-gray-900">Least Borrowed Books</h2>
                </div>
                <div class="p-4 overflow-x-auto">
                    <table class="min-w-full text-sm">
                        <thead class="text-left text-gray-600">
        ...
        <div class="mt-8 bg-white border rounded-lg">
            <div class="p-4 border-b">
                <h2 class="text-lg font-semibold text-gray-900">Category Usage</h2>
            </div>
            <div class="p-4 overflow-x-auto">
                <table class="min-w-full text-sm">
                    <thead class="text-left text-gray-600">
                    ...
                    <tbody class="text-gray-900">
                        ...
                        <tr class="border-t">
                            ...
                            <td class="py-2 pr-4 font-medium">{{ $c->borrow_count }}</td>
