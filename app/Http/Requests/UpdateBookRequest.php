...
class UpdateBookRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'resource_type' => 'nullable|string|in:book,e_journal,thesis,homegrown',
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            // Check for duplicate book by title and author combination (excluding current book)
            if ($this->title && $this->author) {
                ...
                if ($existingBook) {
                    $validator->errors()->add('title', 'Another book with this title and author already exists in the system.');
                }
            }
        });
    }
